...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1287: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1288: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1290: () => globalThis.firebase_core.getApp(),
      _1291: (x0,x1) => x0.createElement(x1),
      _1292: (x0,x1) => x0.debug(x1),
      ...
      _1295: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1296: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1297: (x0,x1) => x0.createScriptURL(x1),
      _1298: (x0,x1,x2) => x0.createScript(x1,x2),
      ...
      _1301: () => globalThis.firebase_core.SDK_VERSION,
      _1307: x0 => x0.apiKey,
      _1309: x0 => x0.authDomain,
      _1311: x0 => x0.databaseURL,
      _1313: x0 => x0.projectId,
      _1315: x0 => x0.storageBucket,
      _1317: x0 => x0.messagingSenderId,
      _1319: x0 => x0.measurementId,
      _1321: x0 => x0.appId,
      _1323: x0 => x0.name,
      _1324: x0 => x0.options,
      _1325: Date.now,
      ...
      _1455: () => new AbortController(),
      _1456: x0 => x0.abort(),
      _1457: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1458: (x0,x1) => globalThis.fetch(x0,x1),
      _1459: (x0,x1) => x0.get(x1),
      _1460: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1460(f,arguments.length,x0,x1,x2) }),
      _1461: (x0,x1) => x0.forEach(x1),
      _1462: x0 => x0.getReader(),
      _1463: x0 => x0.read(),
      _1464: x0 => x0.cancel(),
      _1482: x0 => x0.trustedTypes,
      _1483: (x0,x1) => { x0.text = x1 },
      _1495: (s, m) => {
        try {
      ...
      _1554: (o, p) => o[p],
      _1555: (o, p, v) => o[p] = v,
      _1556: (o, p) => delete o[p],
      _1557: x0 => x0.random(),
      _1560: () => globalThis.Math,
      _1561: Function.prototype.call.bind(Number.prototype.toString),
      _1562: Function.prototype.call.bind(BigInt.prototype.toString),
      _1563: Function.prototype.call.bind(Number.prototype.toString),
      _1564: (d, digits) => d.toFixed(digits),
      _2976: (x0,x1) => { x0.type = x1 },
      _2984: (x0,x1) => { x0.crossOrigin = x1 },
      _2986: (x0,x1) => { x0.text = x1 },
      _3443: () => globalThis.window,
      _3768: x0 => x0.trustedTypes,
      _6050: x0 => x0.signal,
      _6124: () => globalThis.document,
      _6208: x0 => x0.head,
      _7890: x0 => x0.value,
      _7892: x0 => x0.done,
      _8594: x0 => x0.url,
      _8596: x0 => x0.status,
      _8598: x0 => x0.statusText,
      _8599: x0 => x0.headers,
      _8600: x0 => x0.body,
      _12228: x0 => x0.name,
      _12946: () => globalThis.console,
